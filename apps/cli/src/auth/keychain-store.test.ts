...
describe("macOS keychain OAuth token store", () => {
  test("stores, reads, and deletes OAuth tokens through security commands", async () => {
    ...
    expect(calls).toEqual([
      ...
      ["find-generic-password", "-s", "duru.oauth.test", "-a", "WyJub3Rlcy1hcGkiLCJkZXYiLCJ0ZXN0LXByb3ZpZGVyIl0", "-w"],
      ["delete-generic-password", "-s", "duru.oauth.test", "-a", "WyJub3Rlcy1hcGkiLCJkZXYiLCJ0ZXN0LXByb3ZpZGVyIl0"],
    ]);
  });

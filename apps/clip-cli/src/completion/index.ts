import { queryCompletionItems, renderZshCompletion } from "@clip/completion-zsh";
import type { ZshCompletionStyle } from "@clip/completion-zsh";
import { createCli, createPlugin } from "@clip/kit";
import type { CliPlugin, CliPluginApi, CompletionContext, CompletionResult } from "@clip/kit";

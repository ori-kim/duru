    ...
    const server = Bun.serve({
      ...
      fetch(request) {
          ...
          return htmlResponse(
            {
              ...
              message: "Clip could not complete the login.",
        ...
        return htmlResponse({
          ...
          message: "Clip is ready. You can close this tab and return to the terminal.",
        });
      },
    });
  });
...
<html lang="en">
  ...
  <body>
    <main>
      <img class="app-icon" src="/icon.png" alt="Clip">
